...
class TestA2AStorageFactory:
    ...
    @pytest.mark.asyncio
    async def test_invalid_storage_type_raises_error(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_sqlite_storage_type_without_config_raises_error(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_postgres_storage_type_without_config_raises_error(self) -> None:
